			...
			<ul id="main-nav"> 				
				...
				<li> 
					...
					<ul>
						...
						<li><a class="current" href="receiveFile.action">接收文件</a></li> 
					</ul>
				</li>
		...
		<!-- Page Head -->			
			...
			<table width="100%" align=center cellpadding="0" cellspacing="0">
				<tr style="background-color:#c1d9f3;height:23">
					...
					<th style="border-bottom:0px solid #154ba0;">发件人</th>
					<th style="border-bottom:0px solid #154ba0">简要主题</th>
					<th style="border-bottom:0px solid #154ba0">时间</th>
					<th style="border-bottom:0px solid #154ba0">文件</th>
				</tr>
				...
				<tr style="background-color:#c1d9f3;height:23">
					...
					<tr style="height:23px;">
						<td>&nbsp<s:submit onclick="document.getElementById('delform').submit();return false;" value="删除"/></td>
						<td></td>
						<td></td>
						<td align="right">
