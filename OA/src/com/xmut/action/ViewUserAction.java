...
import com.xmut.entity.NewUser;
public class ViewUserAction extends FenYeAction{
	...
	public List getUserList(){
		...
		String sql="select userName,realName,gender,deptName,roleName,phone,userNumber from("+
				"select  ROW_NUMBER() OVER (ORDER BY userNumber asc) AS rn,userName,realName,gender,deptName,roleName,phone,userNumber from("+
				...
				")st)st where rn>"+begin+" and rn<="+end;
